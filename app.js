const storageKey = 'nexo-m01-state';
...
const builderBlocks = [
  ...
  { title: 'Deploy', text: 'Sitio estático listo para publicarse en GitHub Pages.' }
];
...
function makePlan(idea) {
  ...
  const tasks = [
    ...
    'Publicar en GitHub Pages y validar desde un teléfono.'
  ];
